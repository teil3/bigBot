...
motor_shaft = 6.4;	// NEMA17 motor shaft exact diameter = 5
...
pulley_t_ht = 5.8;	// length of toothed part of pulley, standard = 12
	...
	difference()
	 {	 
		...
		union()
		{
			...
			translate([0,0,-13])cylinder(r=9/2,h=11,$fn=motor_shaft*4);
//			translate([0,0,7.8])cylinder(r=9/2,h=11,$fn=motor_shaft*4);
		difference()
			{
		...
		#rotate([0,180,0])rotate_extrude($fn=teeth*4)  
		polygon([[0,0],[pulley_OD/2,0],[pulley_OD/2 + retainer_ht , retainer_ht],[0 , retainer_ht],[0,0]]);}
		...
		#translate([0,0,-20])cylinder(r=motor_shaft/2,h=pulley_b_ht + pulley_t_ht + retainer_ht + 40,$fn=motor_shaft*4);
